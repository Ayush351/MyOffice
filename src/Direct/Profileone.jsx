            ...
            <div className="col-xl-8 m-auto order-xl-2 mb-5 mb-xl-0 ">
              ...
              >
                <div className="container p-3 ">
                  <div className="row">
                    <div className="col-9">
                      <div class="shadow-sm p-3 mb-3 bg-white rounded">
                        <strong>Name :</strong> Vichaar Gupt
                      </div>
                      <div class="shadow-sm p-3 mb-3 bg-white rounded">
                        <strong>Employee ID :</strong> VIC012556
                      </div>
                      <div class="shadow-sm p-3 mb-3 bg-white rounded">
                  ...
                  <div class="shadow-sm p-3 mb-3 bg-white rounded">
                    <strong>Team ID :</strong> VICT9876
                  </div>
                  <div className="row">
                    <div className="col-lg-6 col-sm-12">
                      <div class="shadow-sm p-3 mb-3 bg-white rounded">
                        <strong>Email :</strong> VichaarGupt@vichaardhara.com
                      </div>
                    </div>
                    <div className="col-lg-6 col-sm-12">
                      <div class="shadow-sm p-3 mb-3 bg-white rounded">
                        <strong>Github :</strong> Vichy-Gupt
                      </div>
                    </div>
                  </div>
                </div>
